...
They haven’t really changed the layouts at all, though, just doubled up the floor space. This means that one shop has two dairy sections, two dried goods aisles, two walls full of pet food, and two drinks fridges. The stock on each side is almost identical, but now I’m walking through theme side-by-side, I’ve been noticing the differences. The sliced cheese on one side looks the same as on the other, but it’s actually a totally different brand, just with similar graphics. The coca-cola on one side is pepsi on the other. The Kiełbasa myśliwska (keow-BAH-sah mish-LEEV-skah) on side is Kiełbasa weselna (keow-BAH-sah vuh-SELL-neh) on the other. That sort of thing.
