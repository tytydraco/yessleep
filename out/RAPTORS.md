...
I used to hate living in my apartment. Despite my attempts to make it as comfortable and decorative as I can get, I abhorred the building's location. Deep in the city San Francisco California, close to a junction, where traffic would build up to the point I couldn't open my window without being blasted by an orchestra or engine roars, horn beeps and tires screeching on the ground. Even worse at night when the building across from me would throw a party.  
