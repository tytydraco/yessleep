...
I clicked out of the video, then scrolled down to some random day in 2025. I clicked, then the video loaded. It began with a view of a drive along a road between two endless fields of grass. The camera panned to the passenger side window, where a black orb with a shifty gooey appearance floated alongside the car. A chill ran down my spine. It was so realistic, I couldn't put weight on the idea of the video being a scene from an unreleased film.
